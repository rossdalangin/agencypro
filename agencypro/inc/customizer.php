...
function agencypro_customize_register( $wp_customize ) {
    ...
    function agencypro_add_section_controls($id, $details, $wp_customize) {
        ...
        $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, "agencypro_{$id}_bg_color", ['label' => 'BG Color', 'section' => "agencypro_{$id}_section", 'active_callback' => function() use ($wp_customize, $id) { return 'color' === $wp_customize->get_setting("agencypro_{$id}_bg_type")->value(); }, 'priority' => 4]));
        $wp_customize->add_setting("agencypro_{$id}_bg_image", ['default' => '', 'sanitize_callback' => 'esc_url_raw']);
        $wp_customize->add_control(new WP_Customize_Image_Control($wp_customize, "agencypro_{$id}_bg_image", ['label' => 'BG Image', 'section' => "agencypro_{$id}_section", 'active_callback' => function() use ($wp_customize, $id) { return 'image' === $wp_customize->get_setting("agencypro_{$id}_bg_type")->value(); }, 'priority' => 4]));
        $wp_customize->add_setting("agencypro_{$id}_bg_gradient_1", ['default' => '#1e1e1e', 'sanitize_callback' => 'sanitize_hex_color']);
        $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, "agencypro_{$id}_bg_gradient_1", ['label' => 'Gradient 1', 'section' => "agencypro_{$id}_section", 'active_callback' => function() use ($wp_customize, $id) { return 'gradient' === $wp_customize->get_setting("agencypro_{$id}_bg_type")->value(); }, 'priority' => 4]));
        $wp_customize->add_setting("agencypro_{$id}_bg_gradient_2", ['default' => '#121212', 'sanitize_callback' => 'sanitize_hex_color']);
        $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, "agencypro_{$id}_bg_gradient_2", ['label' => 'Gradient 2', 'section' => "agencypro_{$id}_section", 'active_callback' => function() use ($wp_customize, $id) { return 'gradient' === $wp_customize->get_setting("agencypro_{$id}_bg_type")->value(); }, 'priority' => 5]));
    }
    $sections = ['hero' => ['label' => 'Hero', 'priority' => 10, 'order' => 10], 'clients' => ['label' => 'Clients', 'priority' => 20, 'order' => 20], 'services' => ['label' => 'Services', 'priority' => 30, 'order' => 30], 'portfolio' => ['label' => 'Portfolio', 'priority' => 40, 'order' => 40], 'promo' => ['label' => 'Promo', 'priority' => 45, 'order' => 45], 'testimonials' => ['label' => 'Testimonials', 'priority' => 50, 'order' => 50], 'cta' => ['label' => 'CTA', 'priority' => 60, 'order' => 60]];
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'agencypro_accent_color', ['label' => 'Accent Color', 'section' => 'agencypro_typography_colors_section']));
    ...
    $wp_customize->add_control('agencypro_heading_font_family', ['label' => 'Heading Font', 'section' => 'agencypro_typography_colors_section', 'type' => 'select', 'choices' => ['Montserrat' => 'Montserrat', 'Roboto' => 'Roboto', 'Poppins' => 'Poppins']]);
}
