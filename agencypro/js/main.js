(function($) {
    ...
    $(function() {
        ...
        $menuToggle.on('click', function() { $mainNav.toggleClass('toggled'); });
        ...
        function loadProjects(replace) {
            $.ajax({
                ...
                type: 'post',
                dataType: 'json',
                data: { action: 'filter_portfolio', nonce: agencypro_ajax_obj.nonce, term: currentTerm, page: currentPage },
                beforeSend: function() {
                ...
                success: function(response) {
                    if(response.success) {
                        ...
                        if (replace) { container.html(newContent); } else { container.append(newContent); }
